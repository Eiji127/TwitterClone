...
class TweetHeader: UICollectionReusableView {
    ...
    private let captionLabel: UILabel = {
        ...
        label.text = "Some test caption from humberg for now"
        return label
    }()
    ...
    private lazy var retweetButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(handleRweetTapped), for: .touchUpInside)
        return button
    }()
